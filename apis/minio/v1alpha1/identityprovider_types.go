...
// +kubebuilder:printcolumn:name="Display Name",type="string",JSONPath=".status.atProvider.displayName"
...
type IdentityProviderProviderStatus struct {
	...
	// Comma-separated ist of scopes.
	Scopes string `json:"scopes,omitempty"`

	// Fully Qualified Domain Name (FQDN) the MinIO Console listens for incoming connections on.
	RedirectUrl string `json:"redirectUrl,omitempty"`

	// Name of the identity provider.
	Name string `json:"name,omitempty"`

	// User-facing name the MinIO Console displays on the login screen.
	DisplayName string `json:"displayName,omitempty"`

	// Name of the JWT Claim MinIO uses to identify the policies to attach to the authenticated user.
...
var (
	...
	IdentityProviderGroupKind        = schema.GroupKind{Group: ApiGroup, Kind: IdentityProviderKind}.String()
